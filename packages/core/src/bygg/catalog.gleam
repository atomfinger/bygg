  ...
  [
    Package(
      ..default(
        ...
        default_constraint: ">= 1.0.2 and < 2.0.0",
      ),
      is_hidden: True,
    ...
    Package(
      ..default(
        ...
        default_constraint: ">= 1.3.0 and < 2.0.0",
      ),
      targets: ErlangOnly,
    ...
    Package(
      ..default(
        ...
        default_constraint: ">= 1.2.0 and < 2.0.0",
      ),
      targets: ErlangOnly,
    ...
    Package(
      ..default(
        ...
        default_constraint: ">= 2.2.2 and < 3.0.0",
      ),
      targets: ErlangOnly,
      category: Http,
      roles: [WebFramework],
    ...
    Package(
      ..default(
        ...
        default_constraint: ">= 6.0.3 and < 7.0.0",
      ),
      targets: ErlangOnly,
      category: Http,
      roles: [HttpServer],
    ...
    Package(
      ..default(
        ...
        default_constraint: ">= 4.3.0 and < 5.0.0",
      ),
      category: Http,
    ...
    Package(
      ..default(
        ...
        default_constraint: ">= 1.1.0 and < 2.0.0",
      ),
      targets: ErlangOnly,
      category: Database,
    ...
    Package(
      ..default(
        ...
        default_constraint: ">= 4.1.1 and < 5.0.0",
      ),
      targets: ErlangOnly,
      category: Database,
      requires_otp: True,
    ...
    Package(
      ..default(
        ...
        default_constraint: ">= 3.1.0 and < 4.0.0",
      ),
    ...
    Package(
      ..default(
        ...
        default_constraint: ">= 5.7.0 and < 6.0.0",
      ),
    ...
    Package(
      ..default(
        ...
        default_constraint: ">= 2.3.6 and < 3.0.0",
      ),
      targets: JavaScriptOnly,
      category: Ui,
      dev_only: True,
    ...
    Package(
      ..default(
        ...
        default_constraint: ">= 4.1.0 and < 5.0.0",
      ),
      targets: ErlangOnly,
      category: Database,
      requires_otp: True,
